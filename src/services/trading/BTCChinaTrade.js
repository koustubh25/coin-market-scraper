...
var TradeData = require('./TradeData');

//temporary variables
//============

json_web_token = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwczpcL1wvd3d3LmJ0Y2MuY29tIiwiYXVkIjoiODkyNTk2IiwiZXhwIjoxNTAwMjc1NjE4LCJpYXQiOjE1MDAyNTM5MjksIm90cCI6ZmFsc2UsInJlbSI6ZmFsc2UsImFwaSI6ImFjY291bnQifQ.bGPyrKt9Ktd-lKrAyikmAij7hzBbNO7Tj988TiG80Qg';
start_timestamp = 1500217199.999;
end_timestamp = 1500389999.999;
results_in_single_page = 20;
page_no = 1;
...
class BTCChinaTrade extends TradeData{
  constructor() {
    super("https://www.btcchina.com/api.php/trade");
    if(!instance) {
      instance = this;
    }
    this.market = "cnybtc";
  ...
  getTradeData(start_timestamp, end_timestamp, json_web_token, results_in_single_page, page_no) {
    ...
    var options = {
      ...
      body: '{"jsonrpc":"2.0","method":"getHistoryPaginator","id":"97b5ec48-a1ce-4080-979f-2d1175601ee3","params":{"market":"' + this.market + '","fromtime":' + start_timestamp + ',"totime":' + end_timestamp + ',"page":' + page_no + ',"count_per_page":' + results_in_single_page + '}}'
    };
    ...
    return new Promise((resolve, reject) =>
    {
      request(options, function (error, response, body) {
        ...
        if(body == -32041) {
          reject("Error occurred: Please update the jwt token");
        }
        ...
        try {
          ...
          reject(e);
          //need to implement here to refresh jwt
          return false;
        }
      });
    });
